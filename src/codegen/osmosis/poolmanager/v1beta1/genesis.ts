...
export const TakerFeeParams = {
  ...
  encode(message: TakerFeeParams, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    ...
    if (message.affiliateFee !== "") {
      writer.uint32(58).string(Decimal.fromUserInput(message.affiliateFee, 18).atomics);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break;
        case 7:
          message.affiliateFee = Decimal.fromAtomics(reader.string(), 18).toString();
          break;
        default:
          reader.skipType(tag & 7);
          break;
  ...
  fromPartial(object: Partial<TakerFeeParams>): TakerFeeParams {
    ...
    message.affiliateFee = object.affiliateFee ?? "";
    return message;
  },
  fromAmino(object: TakerFeeParamsAmino): TakerFeeParams {
    ...
    if (object.affiliate_fee !== undefined && object.affiliate_fee !== null) {
      message.affiliateFee = object.affiliate_fee;
    }
    return message;
  },
  toAmino(message: TakerFeeParams): TakerFeeParamsAmino {
    ...
    obj.affiliate_fee = message.affiliateFee === "" ? undefined : message.affiliateFee;
    return obj;
  },
