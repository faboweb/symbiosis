...
/** TODO */
export interface RevenueShareUser {
...
export interface RevenueShareUserProtoMsg {
  typeUrl: "/osmosis.poolmanager.v1beta1.RevenueShareUser";
  value: Uint8Array;
}
/** TODO */
export interface RevenueShareUserAmino {
  /** user_address is the address of the user that has a revenue share agreement. */
  user_address?: string;
  /** parents is the chain of addresses that the revenue share will be distributed to. */
  parents?: string[];
}
export interface RevenueShareUserAminoMsg {
  type: "osmosis/poolmanager/revenue-share-user";
  value: RevenueShareUserAmino;
}
/** TODO */
export interface RevenueShareUserSDKType {
  user_address: string;
  parents: string[];
}
...
function createBaseRevenueShareUser(): RevenueShareUser {
  return {
    userAddress: "",
    parents: []
  };
}
export const RevenueShareUser = {
  typeUrl: "/osmosis.poolmanager.v1beta1.RevenueShareUser",
  encode(message: RevenueShareUser, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RevenueShareUser {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRevenueShareUser();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: Partial<RevenueShareUser>): RevenueShareUser {
    const message = createBaseRevenueShareUser();
    message.userAddress = object.userAddress ?? "";
    message.parents = object.parents?.map(e => e) || [];
    return message;
  },
  fromAmino(object: RevenueShareUserAmino): RevenueShareUser {
    const message = createBaseRevenueShareUser();
  ...
  toAmino(message: RevenueShareUser): RevenueShareUserAmino {
    const obj: any = {};
  ...
  fromAminoMsg(object: RevenueShareUserAminoMsg): RevenueShareUser {
    return RevenueShareUser.fromAmino(object.value);
  },
  toAminoMsg(message: RevenueShareUser): RevenueShareUserAminoMsg {
    return {
      type: "osmosis/poolmanager/revenue-share-user",
      value: RevenueShareUser.toAmino(message)
    };
  },
  fromProtoMsg(message: RevenueShareUserProtoMsg): RevenueShareUser {
    return RevenueShareUser.decode(message.value);
  },
  toProto(message: RevenueShareUser): Uint8Array {
    return RevenueShareUser.encode(message).finish();
  },
  toProtoMsg(message: RevenueShareUser): RevenueShareUserProtoMsg {
    return {
      typeUrl: "/osmosis.poolmanager.v1beta1.RevenueShareUser",
      value: RevenueShareUser.encode(message).finish()
    };
  }
};