...
export interface MsgSetRevenueShareUser {
  sender: string;
  referrer: string;
}
export interface MsgSetRevenueShareUserProtoMsg {
  typeUrl: "/osmosis.poolmanager.v1beta1.MsgSetRevenueShareUser";
  value: Uint8Array;
}
/** ===================== MsgSetRevenueShareUser */
export interface MsgSetRevenueShareUserAmino {
  sender?: string;
  referrer?: string;
}
export interface MsgSetRevenueShareUserAminoMsg {
  type: "osmosis/poolmanager/set-revenue-share-user";
  value: MsgSetRevenueShareUserAmino;
}
/** ===================== MsgSetRevenueShareUser */
export interface MsgSetRevenueShareUserSDKType {
  sender: string;
  referrer: string;
}
export interface MsgSetRevenueShareUserResponse {}
export interface MsgSetRevenueShareUserResponseProtoMsg {
  typeUrl: "/osmosis.poolmanager.v1beta1.MsgSetRevenueShareUserResponse";
  value: Uint8Array;
}
export interface MsgSetRevenueShareUserResponseAmino {}
export interface MsgSetRevenueShareUserResponseAminoMsg {
  type: "osmosis/poolmanager/set-revenue-share-user-response";
  value: MsgSetRevenueShareUserResponseAmino;
}
export interface MsgSetRevenueShareUserResponseSDKType {}
...
function createBaseMsgSetRevenueShareUser(): MsgSetRevenueShareUser {
  return {
    sender: "",
    referrer: ""
  };
}
export const MsgSetRevenueShareUser = {
  typeUrl: "/osmosis.poolmanager.v1beta1.MsgSetRevenueShareUser",
  encode(message: MsgSetRevenueShareUser, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.referrer !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSetRevenueShareUser {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSetRevenueShareUser();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(object: Partial<MsgSetRevenueShareUser>): MsgSetRevenueShareUser {
    const message = createBaseMsgSetRevenueShareUser();
    message.sender = object.sender ?? "";
    message.referrer = object.referrer ?? "";
    return message;
  },
  fromAmino(object: MsgSetRevenueShareUserAmino): MsgSetRevenueShareUser {
    const message = createBaseMsgSetRevenueShareUser();
    if (object.sender !== undefined && object.sender !== null) {
      message.sender = object.sender;
    }
  ...
  toAmino(message: MsgSetRevenueShareUser): MsgSetRevenueShareUserAmino {
    const obj: any = {};
    obj.sender = message.sender === "" ? undefined : message.sender;
    obj.referrer = message.referrer === "" ? undefined : message.referrer;
    return obj;
  },
  fromAminoMsg(object: MsgSetRevenueShareUserAminoMsg): MsgSetRevenueShareUser {
    return MsgSetRevenueShareUser.fromAmino(object.value);
  },
  toAminoMsg(message: MsgSetRevenueShareUser): MsgSetRevenueShareUserAminoMsg {
    return {
      type: "osmosis/poolmanager/set-revenue-share-user",
      value: MsgSetRevenueShareUser.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgSetRevenueShareUserProtoMsg): MsgSetRevenueShareUser {
    return MsgSetRevenueShareUser.decode(message.value);
  },
  toProto(message: MsgSetRevenueShareUser): Uint8Array {
    return MsgSetRevenueShareUser.encode(message).finish();
  },
  toProtoMsg(message: MsgSetRevenueShareUser): MsgSetRevenueShareUserProtoMsg {
    return {
      typeUrl: "/osmosis.poolmanager.v1beta1.MsgSetRevenueShareUser",
      value: MsgSetRevenueShareUser.encode(message).finish()
    };
  }
};
function createBaseMsgSetRevenueShareUserResponse(): MsgSetRevenueShareUserResponse {
  return {};
}
export const MsgSetRevenueShareUserResponse = {
  typeUrl: "/osmosis.poolmanager.v1beta1.MsgSetRevenueShareUserResponse",
  encode(_: MsgSetRevenueShareUserResponse, writer: BinaryWriter = BinaryWriter.create()): BinaryWriter {
    return writer;
  },
  decode(input: BinaryReader | Uint8Array, length?: number): MsgSetRevenueShareUserResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSetRevenueShareUserResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromPartial(_: Partial<MsgSetRevenueShareUserResponse>): MsgSetRevenueShareUserResponse {
    const message = createBaseMsgSetRevenueShareUserResponse();
    return message;
  },
  fromAmino(_: MsgSetRevenueShareUserResponseAmino): MsgSetRevenueShareUserResponse {
    const message = createBaseMsgSetRevenueShareUserResponse();
    return message;
  },
  toAmino(_: MsgSetRevenueShareUserResponse): MsgSetRevenueShareUserResponseAmino {
    const obj: any = {};
    return obj;
  },
  fromAminoMsg(object: MsgSetRevenueShareUserResponseAminoMsg): MsgSetRevenueShareUserResponse {
    return MsgSetRevenueShareUserResponse.fromAmino(object.value);
  },
  toAminoMsg(message: MsgSetRevenueShareUserResponse): MsgSetRevenueShareUserResponseAminoMsg {
    return {
      type: "osmosis/poolmanager/set-revenue-share-user-response",
      value: MsgSetRevenueShareUserResponse.toAmino(message)
    };
  },
  fromProtoMsg(message: MsgSetRevenueShareUserResponseProtoMsg): MsgSetRevenueShareUserResponse {
    return MsgSetRevenueShareUserResponse.decode(message.value);
  },
  toProto(message: MsgSetRevenueShareUserResponse): Uint8Array {
    return MsgSetRevenueShareUserResponse.encode(message).finish();
  },
  toProtoMsg(message: MsgSetRevenueShareUserResponse): MsgSetRevenueShareUserResponseProtoMsg {
    return {
      typeUrl: "/osmosis.poolmanager.v1beta1.MsgSetRevenueShareUserResponse",
      value: MsgSetRevenueShareUserResponse.encode(message).finish()
    };
  }
};
